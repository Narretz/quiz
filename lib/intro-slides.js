...
export const EXTRA_SLIDES = {
  ...
  "break-1": {
    ...
    lines: [
      ...
      { text: "Wir sehen uns in 10 Minuten.", fontSize: 20, color: null },
      { text: "See you in 10 minutes.", fontSize: 20, color: null },
    ],
  },
  ...
  "break-2": {
    ...
    lines: [
      { text: "Pause ⬧ Break", fontSize: 40, bold: true, color: null },
      { text: "", fontSize: 10 },
      { text: "Die letzte Chance für euch, noch einmal Wissen für den Jackpot zu sammeln oder euch Mut anzutrinken. Wir sehen uns in 10 Minuten.", fontSize: 20, color: null },
      { text: "The last chance for you to collect knowledge for the jackpot once again or to take courage. See you in 10 minutes.", fontSize: 20, color: null },
    ],
  },
  ...
  "goodbye": {
    ...
    sections: [
      ...
      },
      {
        lang: "en",
        lines: [
          { runs: [{ text: "Any comments or tips, feel free to talk to me! If you want to make a guest round, let me know!" }] },
        ],
      },
      {
        lines: [{ runs: [{ text: "Danke! ⬧ Thank you!", bold: true }] },]
      }
    ],
    defaultFontSize: 19,
    titleY: 0.2,
