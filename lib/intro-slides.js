...
export const INTRO_SLIDES = [
  ...
  {
    id: "welcome",
    title: { text: "Pub Quiz", fontSize: 48, bold: true, color: WHITE },
    subtitle: [
  ...
  // --- Slide 2: Rules & Prizes ---
  {
    ...
    title: {
      ...
      fontSize: 30, bold: true, underline: true, color: WHITE, align: "center",
    },
    sections: [
      {
        lang: "de",
        lines: [
          { runs: [{ text: "5 Euro pro Team für die Anmeldung. Sag mir Bescheid, wenn ihr nicht registriert seid!", color: WHITE }] },
          { runs: [
            { text: "5 Fragerunden = ", color: WHITE },
            { text: "Whisky", color: ORANGE, underline: true, fontSize: 21 },
            { text: " und ", color: WHITE },
            { text: "Gewürzgurken", color: GREEN, bold: true, underline: true, fontSize: 19 },
            { text: " als Preis", color: WHITE },
          ]},
          { runs: [{ text: "+", color: WHITE }] },
          { runs: [
            { text: "4 Jackpot-Fragen = ca. ", color: WHITE },
      ...
      },
      {
        lang: "en",
        lines: [
          { runs: [{ text: "5 Euros per team to register. Let me know if you're not registered!", color: WHITE }] },
          { runs: [
            { text: "5 Rounds of questions = ", color: WHITE },
            ...
            { text: " prize", color: WHITE },
          ]},
          { runs: [{ text: "+", color: WHITE }] },
          { runs: [
            { text: "4 Jackpot questions = ca. ", color: WHITE },
  ...
  // --- Slide 3: Quiz Format ---
  {
    ...
    title: {
      text: "Quiz Format",
      fontSize: 32, underline: true, color: WHITE, align: "center", fontFace: "Impact",
    },
    sections: [
      {
        lang: "de",
  ...
  // --- Slide 5: Let Us Begin ---
  {
    id: "begin",
    lines: [
      { text: "Lasst uns anfangen!", fontSize: 24, bold: true, color: WHITE },
      { text: "Let us begin!", fontSize: 24, bold: true, color: WHITE },
    ],
    align: "center",
  },
];
